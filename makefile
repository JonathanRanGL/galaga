...
$(BIN_DIR)/%.exe: $(SRC_DIR)/%.cpp include/Game.hpp include/Nave.hpp include/Proyectil.hpp include/Enemigo.hpp include/Abeja.hpp include/Mariposa.hpp include/Jefe.hpp include/Puntaje.hpp
	g++ $< -o $@ $(SFML) -Iinclude
